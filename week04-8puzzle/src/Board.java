...
public class Board {
	...
	private final int N;
	/**
	 * Every time a new instance is created, the goal is created
	 ...
	 * 
	 * @param blocks {@code n}-by-{@code n} array of blocks with values
	 * 		         in the range [0, {@code n}^2).
	 */
    ...
    /**
     * Swap the elements of the multidimensional array {@code mat}
     * specified by the indexes {@code first} and {@code second}.
     * 
